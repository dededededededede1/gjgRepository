...
let { name: nickName, age, sex, like } = person; // 对象的结构赋值

console.log(nickName); // 打印结果：qianguyihao
...
console.log(person.name); // 打印结果：qianguyihao
